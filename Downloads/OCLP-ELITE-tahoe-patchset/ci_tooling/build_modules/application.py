...
from oclp_elite.volume  import generate_copy_arguments
from oclp_elite.support import subprocess_wrapper


class GenerateApplication:
    """
    Generate OCLP-ELITE.app
    """
    ...
    def __init__(self, reset_pyinstaller_cache: bool = False, git_branch: str = None, git_commit_url: str = None, git_commit_date: str = None, analytics_key: str = None, analytics_endpoint: str = None) -> None:
        ...
        self._application_output = Path("./dist/OCLP-ELITE.app")
    ...
    def _generate_application(self) -> None:
        ...
        print("Generating OCLP-ELITE.app")
        _args = self._pyinstaller + ["./OCLP-ELITE.spec", "--noconfirm"]
    ...
    def _embed_analytics_key(self) -> None:
        ...
        Embed analytics key
        """
        _file = Path("./oclp_elite/support/analytics_handler.py")
    ...
    def _patch_load_command(self):
        ...
        To verify set version:
          ...
          version 10.13
              sdk 10.9
        """
        _file = self._application_output / "Contents" / "MacOS" / "OCLP-ELITE"
