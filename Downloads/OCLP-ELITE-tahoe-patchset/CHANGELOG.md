...
- Fix Missing Patches
- Update Kexts To Stable Version
- It Works On macs from 2012-2019
 - OpenCorePkg 1.0.7
 - Added iMacPro1,1 SMBIOS
...
- Backend changes:
  ...
  - Reimplement wxPython GUI into modularized system:
    ...
    - Changes include:
      ...
      - Expand app update checks to include beta users
        - ex. 0.6.6 beta -> 0.6.6 release
