...
Please check the Github page for more information about this release."""
            ...
            self.description = wx.StaticText(panel, label=f"OCLP-ELITE {version} is now available - You have {self.constants.patcher_version}{' (Beta)' if not self.constants.commit_info[0].startswith('refs/tags') else ''}. Would you like to update?")
