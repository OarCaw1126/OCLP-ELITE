    ...
    def _settings(self) -> dict:
        ...
        settings = {
            ...
            "Developer": {
                ...
                "Install latest beta build 🧪": {
                    "type": "button",
                    "function": self.on_beta,
                    "description": [
...
"""
    ...
    def on_beta(self, event: wx.Event) -> None:
        ...
        gui_update.UpdateFrame(
            ...
            global_constants=self.constants,
            screen_location=self.parent.GetPosition(),
            url=f"https://beta.link/dortania/OpenCore-Legacy-Patcher/workflows/build-app-wxpython/{branch}/OCLP-ELITE.pkg.zip",
            version_label="(Beta)"
        )
