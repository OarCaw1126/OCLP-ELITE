...
class HardwarePatchsetValidation(StrEnum):
    ...
    """
    UNSUPPORTED_HOST_OS           = "Validation: Update To macOS 10.13-26 to Patch"
    MISSING_NETWORK_CONNECTION    = "Validation: Install Kdk To Continue Without WiFi"
    FILEVAULT_ENABLED             = "Validation: FileVault is enabled"
    SIP_ENABLED                   = "Validation: System Integrity Protection"
...
class HardwarePatchsetDetection:
    ...
    def _validation_check_unsupported_host_os(self) -> bool:
        ...
        """
        _min_os = os_data.high_sierra.value
        _max_os = os_data.golden_gate.value
    ...
    def _validation_check_filevault_is_enabled(self) -> bool:
        ...
        # OCLP-ELITE exposes whether it patched APFS.kext to allow for FileVault
    ...
    def _already_has_networking_patches(self) -> bool:
        ...
        """
        oclp_patch_path = "/System/Library/CoreServices/OCLP-ELITE.plist"
