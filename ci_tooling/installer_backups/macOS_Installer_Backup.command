...
# To allow easy importing of OCLP-ELITE's utilities
sys.path.append(str(Path(__file__).parent.parent.parent))

from oclp_elite.support import (
    macos_installer_handler,
    network_handler,
    integrity_verification,
    utilities,
)
from oclp_elite.datasets import os_data
...
class InstallerBackup:
    ...
    def __init__(self,
        ...
        self._os_table = {
            ...
            os_data.os_data.golden_gate: Path(self._directory, "27 Tahoe"),
        }
